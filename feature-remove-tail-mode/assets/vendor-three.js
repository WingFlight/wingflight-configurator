...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zr(){return new rr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$r(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qr(){return new rr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$r(),fragmentShader:`
