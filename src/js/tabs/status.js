...
const tab = {
    ...
    axisNames: [
        ...
        { value: 3, text: 'controlAxisThrottle' },
        { value: 4, text: 'controlAxisAux1' },
        { value: 5, text: 'controlAxisAux2' },
        { value: 6, text: 'controlAxisAux3' },
        { value: 7, text: 'controlAxisAux4' },
        { value: 8, text: 'controlAxisAux5' },
        { value: 9, text: 'controlAxisAux6' },
        { value: 10, text: 'controlAxisAux7' },
        { value: 11, text: 'controlAxisAux8' },
        { value: 12, text: 'controlAxisAux9' },
        { value: 13, text: 'controlAxisAux10' },
        { value: 14, text: 'controlAxisAux11' },
        { value: 15, text: 'controlAxisAux12' },
        { value: 16, text: 'controlAxisAux13' },
        { value: 17, text: 'controlAxisAux14' },
        { value: 18, text: 'controlAxisAux15' },
        { value: 19, text: 'controlAxisAux16' },
        { value: 20, text: 'controlAxisAux17' },
        { value: 21, text: 'controlAxisAux18' },
        { value: 22, text: 'controlAxisAux19' },
        { value: 23, text: 'controlAxisAux20' },
        { value: 24, text: 'controlAxisAux21' },
        { value: 25, text: 'controlAxisAux22' },
        { value: 26, text: 'controlAxisAux23' },
        { value: 27, text: 'controlAxisAux24' },
        { value: 28, text: 'controlAxisAux25' },
        { value: 29, text: 'controlAxisAux26' },
        { value: 30, text: 'controlAxisAux27' },
    ],
};
