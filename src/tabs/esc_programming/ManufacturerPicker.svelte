<script>
  ...
  // likewise reported at page level (EscProgramming.svelte). Unlike Rotorflight there is no
  // firmware-version gate: every manufacturer here is supported from API 22.0, the oldest
  // firmware this configurator accepts.
