...
<Tier id="motors.throttle.section">
  <Section label="motorsSectionLabelThrottle">
    <SubSection>
      <Tier id="motors.throttle.escProtocol">
      ...
      {#if isEnabled && !motorState.isDshot}
        <div transition:slide>
          <Tier id="motors.throttle.pwmRate">
      ...
      {#if isEnabled && !motorState.isDshot && protocol !== 0 && !motorState.isCastleLink && !motorState.isSrxl2}
        <div transition:slide>
          <Tier id="motors.throttle.unsyncedPwm">
      ...
      <div transition:slide>
        <Tier id="motors.throttle.endpoints">
          <SubSection label="motorsThrottleEndpoints">
            ...
            <Tier id="motors.throttle.minCommand">
              <Field
                id="throttle-off-pwm"
            ...
            <Tier id="motors.throttle.minThrottle">
              <Field
                id="throttle-min-pwm"
                label="motorsThrottleMinimum"
                unit="μs"
              >
                {#snippet tooltip()}
                  <Tooltip
            ...
            <Tier id="motors.throttle.maxThrottle">
              <Field
                id="throttle-max-pwm"
                label="motorsThrottleMaximum"
                unit="μs"
              >
                {#snippet tooltip()}
                  <Tooltip
