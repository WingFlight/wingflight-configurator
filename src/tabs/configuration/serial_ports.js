...
// Physical port silkscreen labels for boards whose UART numbering doesn't
// match what's printed on the board - keyed by FC.CONFIG.boardDesign.
...
export const BAUD_RATE_OPTIONS = {
  ...
  [PORT_TYPES.BLACKBOX]: [
    "AUTO", "19200", "38400", "57600", "115200", "230400", "250000", "460800",
    "500000", "921600", "1000000", "1500000", "2000000", "2470000",
  ],
...
export const PORT_FUNCTIONS = [
  ...
  { id: 262144, excl: 262144, name: "SBUS_OUT", type: PORT_TYPES.AUTO, minVersion: "12.7.0" },
  { id: 524288, excl: 524288, name: "FBUS_OUT", type: PORT_TYPES.AUTO, minVersion: "12.9.0" },
  { id: 1048576, excl: 1048576, name: "SPORT_MASTER", type: PORT_TYPES.AUTO, minVersion: "12.9.0" },
...
export function getPortFunc(funcId) {
  return PORT_FUNCTIONS.find((func) => func.id == funcId);
}
...
export function getPortBaudrate(port, portType) {
  switch (portType) {
    case PORT_TYPES.MSP:
      return port.msp_baudrate;
    case PORT_TYPES.GPS:
      return port.gps_baudrate;
    case PORT_TYPES.MAVLINK:
      return port.telemetry_baudrate;
    case PORT_TYPES.BLACKBOX:
      return port.blackbox_baudrate;
...
export function setPortBaudrate(port, portType, value) {
  switch (portType) {
    case PORT_TYPES.MSP:
      port.msp_baudrate = value;
      break;
    case PORT_TYPES.GPS:
      port.gps_baudrate = value;
      break;
    case PORT_TYPES.MAVLINK:
      port.telemetry_baudrate = value;
      break;
    case PORT_TYPES.BLACKBOX:
      port.blackbox_baudrate = value;
      break;
    default:
      break;
  }
