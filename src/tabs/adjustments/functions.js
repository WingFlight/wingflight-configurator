...
export function getFunctions() {
    return [
        ...
        { id: 98,   name: 'TVRollF',                    min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 99,   name: 'TVRollB',                    min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 100,  name: 'TVPitchP',                   min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 101,  name: 'TVPitchI',                   min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 102,  name: 'TVPitchD',                   min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 103,  name: 'TVPitchF',                   min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 104,  name: 'TVPitchB',                   min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 105,  name: 'TVYawP',                     min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 106,  name: 'TVYawI',                     min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
        { id: 107,  name: 'TVYawD',                     min: 0,     max: 1000,   ticks: 50,   pips: [ 0, 200, 400, 600, 800, 1000 ] },
